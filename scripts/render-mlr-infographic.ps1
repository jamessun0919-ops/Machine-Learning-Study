...
$htmlPath = Join-Path $repoRoot "docs/specs/assets-src/multiple-linear-regression-summary.html"
$outputPath = Join-Path $repoRoot "src/assets/chapters/multiple-linear-regression-summary.png"
